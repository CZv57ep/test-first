...
def _excel_file_path(tmp_path_factory: TempPathFactory) -> Path:
...
def test_excel(_data_val: NDArray[np.int64] | Sequence[Sequence[Any]], _excel_file_path: Path) -> None:
    """
    ...
    _xl_book = Workbook(_excel_file_path)
    ...
    _xl_book = load_workbook(_excel_file_path)
